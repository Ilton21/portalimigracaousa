  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-blue-50 to-white text-gray-800">
      <header className="text-center py-16 bg-white shadow-sm">
        <h1 className="text-4xl font-bold text-blue-700 mb-4">Portal Imigração USA</h1>
      ...
      <section className="py-20 px-6">
        <h2 className="text-2xl font-semibold text-center text-blue-700 mb-10">Recursos Essenciais</h2>
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {recursos.map((item, index) => (
            <div key={index} className="bg-white p-8 rounded-2xl shadow-md text-center hover:shadow-xl transition-shadow">
              {item.icon}
      ...
      <footer className="text-center py-10 border-t text-gray-500 text-sm">
